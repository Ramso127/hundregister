...
public final class TestData {
	 ...
	 */
	public static final String SCANNER_ADAPTER_CLASS_NAME = "InputReader";

	/**
	 * Detta är namnet på den metod i din inläsningsklass som läser in text från
	 * användaren.
	 */
	public static final String READ_TEXT_METHOD_NAME = "stringReader";

	/**
	 * Detta är namnet på den metod i din inläsningsklass som läser in ett heltal
	 * från användaren.
	 */
	public static final String READ_INTEGER_METHOD_NAME = "intReader";

	/**
	 * Detta är namnet på den metod i din inläsningsklass som läser in ett
	 * decimaltal från användaren.
	 */
	public static final String READ_DECIMAL_METHOD_NAME = "decimalReader";
