/*
 * Denna fil innehåller JUnit-testfall för den andra metoden för att byta plats på hundar U7.7.1.2, den kräver tillgång till AssignmentSevenPointSixTest. Observera att testet bara kontrollerar funktionaliteten, inte att det är implementerat på rätt sätt. Detta ansvarar du själv för..
 *
...
@DisplayName(value = "JUnit-testfall för U7.7.1.2 - byte av plats med Collections.swap")
public class AssignmentSevenPointSevenPointOnePointTwoTest extends AssignmentSevenPointSevenTest {


	private static final MethodUnderTest SWAP_DOGS_USING_CLASS_LIBRARY_METHOD = CUT.getMethod(
			TestData.SWAP_DOGS_USING_CLASS_LIBRARY_METHOD_NAME, "TestData.SWAP_DOGS_USING_CLASS_LIBRARY_METHOD_NAME",
			int.class, int.class);

	protected AssignmentSevenPointSevenPointOnePointTwoTest() {
		super(1, 1);
	}
	...
	public void swapFirstAndLast() {
		...
		SWAP_DOGS_USING_CLASS_LIBRARY_METHOD.invoke(sut, 0, 2);
	...
	public void swapSame() {
		addDogs(BAMSE, RONJA, MOLLY);
		SWAP_DOGS_USING_CLASS_LIBRARY_METHOD.invoke(sut, 1, 1);
		assertDogsAre("Försök att byta plats på första och sista hunden misslyckades", //
				BAMSE, RONJA, MOLLY);
	}
